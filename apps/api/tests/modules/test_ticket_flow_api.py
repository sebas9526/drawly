...
async def test_reserve_then_reserve_again_conflicts(api_client: AsyncClient) -> None:
    ...
    # An unpaid reservation expires at the raffle's own draw_date, not some
    # short fixed timer — plenty of time for the organizer to collect payment.
    assert first.json()["data"]["expires_at"] == "2026-08-01T19:00:00"
